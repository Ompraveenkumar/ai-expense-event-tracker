...
const CreateEvent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const aiResponse = await axios.post('https://ai-event-planner-backend.onrender.com/api/v1/generate-schedule', 
        { prompt: promptText },
      ...
      await axios.post('https://ai-event-planner-backend.onrender.com/api/v1/add-event', 
